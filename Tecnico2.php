...
.nav > li {
    ...
    font-size: 28px;    margin: 45px;     width: 480px; text-align: center;    border-collapse: collapse;    margin: 0 auto;
            ...
            th     {         font-size: 23px;     font-weight: normal;     padding: 8px;     background: #b9c9fe;
...
<body style="background-color: #0c0606 ;">
  ...
  <header>
    ...
    <section>
        ...
        <article>
            <center><h1>Trabajos Pendientes </h1></center><br>
            <?php ?>
	</div>
	...
	<div >
		<div >
			<div > 
                <a href="agregar.php" class="button" method="POST">AGREGAR</a>
				<table class="table" >
					<thead >
						<tr>
							<th>NUM NOTAS</th>
					...
					<tbody>
						...
						$query = mysqli_query($conexion, "SELECT idnotas, nombre, apellido, telefono, equipo, descripcion, fecha, estatus FROM notas" );
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_array($query)) { ?>
								<tr>
                                    ...
                                    <td><a href="eliminar2.php" class="button" method="POST">ELIMINAR</a></td>
